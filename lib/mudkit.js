...
const ANSI_COLOR_START = [27, 91]; // ESC[
const ANSI_COLOR_END = 109; // m
const ANSI_COLOR_DELIM = 59; // ;
const COLORS = {
    0:  'normal',
    1:  'bold',
    2:  'faint',
...
MUDKit.prototype.processChunk = function (chunk, encoding) {
    var mudkit = this, i, l, last = 0, output = '<span>', remaining = '';
        ...
        function processSB () {
            ...
            case TELOPT_TTYPE:
                ...
                if (TELQUAL_SEND === chunk[i+1]) {
                    ...
                    mudkit.sendCommand([SB, TELOPT_TTYPE, TELQUAL_IS, term, IAC, SE]);
                }
                break;
